...
async function success(email, proxy){
    ...
    .setTitle('Winner')
    .setAuthor('Shell', 'https://upload.wikimedia.org/wikipedia/en/thumb/e/e8/Shell_logo.svg/1200px-Shell_logo.svg.png')
    .addField('Account', '||' + email + '||', true)
    .addField('Proxy', '||' + proxy + '||', true)
    .setColor('#00f46a')
    .setFooter('Starbot4 v.017', 'https://yt3.ggpht.com/yti/AJo0G0mAvc--LjEQykQAptRhe0d9YF-T8ALrlDJA9Cqr=s108-c-k-c0x00ffffff-no-rj')
    .setTimestamp();
...
async function dunkinSuccess(email, proxy){
    const embed = new MessageBuilder()
    .setTitle('Winner')
    .setAuthor('Dunkin', 'https://s3.amazonaws.com/cms.ipressroom.com/285/files/20188/5baa7f2e2cfac254c46e1309_Dunkin+Logo/Dunkin+Logo_3b565e2c-b54c-43c5-b5e1-96184fc02d04-prv.jpg')
    .addField('Account', '||' + email + '||', true)
    .addField('Proxy', '||' + proxy + '||', true)
    .setColor('#00f46a')
    .setFooter('Starbot4 v.017', 'https://yt3.ggpht.com/yti/AJo0G0mAvc--LjEQykQAptRhe0d9YF-T8ALrlDJA9Cqr=s108-c-k-c0x00ffffff-no-rj')
...
const global = new Webhook('https://discord.com/api/webhooks/1005588223914946590/5MmQj5Stkzq6FVhWHg1d3CggFy31P6l68K4v939TVQzdvvnUyjNTyUAWp-jzW5-eKzBW');
...
async function globalHook(site, img){    
    ...
    (async () => {
        ...
        .setFooter('Global v.017', 'https://yt3.ggpht.com/yti/AJo0G0mAvc--LjEQykQAptRhe0d9YF-T8ALrlDJA9Cqr=s108-c-k-c0x00ffffff-no-rj')
        .setTimestamp();
        global.send(embed);
    })()
}
...
module.exports ={
    success, test, globalHook, dunkinSuccess
}
