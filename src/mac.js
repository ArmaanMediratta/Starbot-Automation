  ...
  for (let j = 0; j < proxies.length; j++) {
    ...
    try {
      ...
      const firstName = await page.$(
        '[name="data[Sweepuserentry][first_name]"]'
      );
      await firstName.type(random_name({ first: true }));
    } catch (e) {
      console.log(
        "\x1b[31m%s\x1b[0m",
        "Task" + accountIndex + ": Error entering first name, stopping"
      );
      await browser.close();
      break;
    }
    ...
    try {
      ...
      console.log(
        "\x1b[31m%s\x1b[0m",
        "Task" + accountIndex + ": Error entering last name, stopping"
      );
      await browser.close();
      break;
    }
    ...
    try {
      ...
      console.log(
        "\x1b[31m%s\x1b[0m",
        "Task" + accountIndex + ": Error entering email, stopping"
      );
      await browser.close();
      break;
    }
    ...
    try {
      console.log(
        "\x1b[36m%s\x1b[0m",
        "Task" + accountIndex + ": Entering phone number"
      );
      var phoneNumber =
        getRandomInt(9) +
        getRandomInt(9) +
      ...
      console.log(
        "\x1b[31m%s\x1b[0m",
        "Task" + accountIndex + ": Error phone number, stopping"
      );
      await browser.close();
      break;
    }
    ...
    try {
      console.log(
        "\x1b[36m%s\x1b[0m",
        "Task" + accountIndex + ": Adding birthday"
      );
      shuffle(months);
      shuffle(days);
      shuffle(years);
      ...
      var year = years[3];
      await page.select(
        'select[name="data[Contact][date][month]"]',
        String(month)
      );
      await sleep(1000);
      ...
      await sleep(1000);
      await page.select(
        'select[name="data[Contact][date][year]"]',
        String(year)
      );
      await sleep(1000);
    } catch (e) {
      ...
      console.log(
        "\x1b[31m%s\x1b[0m",
        "Task" + accountIndex + ": Error adding birthday, stopping"
      );
      await browser.close();
      break;
    }
    ...
    try {
      ...
      console.log(
        "\x1b[31m%s\x1b[0m",
        "Task" + accountIndex + ": Error , stopping"
      );
      await browser.close();
      break;
    }
    console.log(
      "\x1b[36m%s\x1b[0m",
      "Task" + accountIndex + ": Requesting captcha"
    );
    try {
      ...
      console.log(
        "\x1b[31m%s\x1b[0m",
        "Task" + accountIndex + ": Error solving captcha, stopping"
      );
      await browser.close();
      break;
    }
    ...
    try {
      console.log(
        "\x1b[36m%s\x1b[0m",
        "Task" + accountIndex + ": Submitting entry"
      );
      ...
      if (
        extractedText.includes("Confirmation") &&
        extractedText.includes("received")
      ) {
        console.log(
          "\x1b[32m%s\x1b[0m",
          "Task" + accountIndex + ": Submitted entry"
        );
      } else {
        console.log(
          "\x1b[31m%s\x1b[0m",
          "Task" + accountIndex + ": Error submitting entry, stopping"
        );
      }
      await browser.close();
      break;
